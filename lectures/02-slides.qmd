...
9:40 - 9:50 Slides
9:50 - 10:00 Tutorial Step 1 configure software (together)
10:00 - 10:20 Tutorial Step 2 (in team of two, one instruction, the other types)
10:20 - 10:30 Wrap up and more questions 

BREAK

3. DEEP DIVE GIT AND GITHUB
10:40 - 11:00 Slides + demo Git Conflict

4. HW1 
11:00 - 11:15 Accept together and overview
...
- locally = your Workbench (for this course) 
...
Version Control is the general name for a system that records every change you make to your files in a folder and lets you restore previous versions of your files in that folder.  
...
Without Version Control (e.g. Git) you have to track changes *manually*, and rename the file every time, which can be messy and hard to manage, like:
...
You can use **Git** by itself to track changes on your own computer.

Most often though, Git s used together with a platform like **GitHub**, which keeps an online copy of your Git local repo and makes it easier to share, submit, and collaborate.

With Git (local) + GitHub (online) you can:
...
**Step 1: Configure your Setup:** Set up Git, GitHub, and RStudio

**Step 2: Use Git and GitHub in RStudio Tutorial:** Complete the tutorial to practice using version control in RStudio

---

## 💻 Step 1: Configure your Setup

#### Complete <https://brinasab.github.io/css-website-summer/setup/setup-workbench.html>

---

## 💻 Step 2: Use Git and GitHub in RStudio Tutorial

#### Once Step 1 is done, complete  <https://brinasab.github.io/css-website-summer/setup/setup-test.html>
...
- Keep track of your questions as you go and let us know if you need help! 

</br>

---

## Recap: Git & GitHub Workflow (use it for all take-home assigments)
...
The following slides cover more advanced topics but might be handy if you run into problems in the assignments and beyond.
...
The local (on your computer) and remote (online on GitHub) repos are expected to match (same identical content). If they don't, Git tries to merge them automatically, with two possible outcomes:

✅ If the changes are in different parts of the file, Git **merges them automatically** and no action is needed.
...
**Scenario 2: Working Solo**  
- You make changes locally and also edit the same file directly on GitHub  
- Conflict: Git can’t tell which version to keep  
- Tip: DO NOT modify the Github (online) repo directly! Always work in your local repo first, then push to GitHub 
...
1. Go to R (Workbench) and open your terminal. Pull the latest changes from GitHub by typing `git pull origin main`. Then read the message that shows up on Git: it will tell you what to do.
   
2. Open the file or files and look for the specific conflict markers such as `<<<<<<<`, `=======`, `>>>>>>>`
...
Accept Homework 1 from the course website.

Note: this will only work if you put your GitHub username on the Excel sheet (Lecture 1) and you accepted the invite to our organization (which was sent to the email linked to your GitHub account)!

---

## Reminders

- To access and complete Homework 1, make sure you have:
  - Registered a GitHub account and submitted your username (Lecture 1)
  - Set up your computer (Lecture 2)
- Check the Course Schedule for Homework 1 due date: this is the only P/F assignment and has a shorter turnaround because we need everyone’s setup ready ASAP.
