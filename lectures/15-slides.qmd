...
For example, the variable `decisionDirection` takes four values: 1 = Conservative, 2 = Liberal, 3 = Other, and NA.  This code recodes it to three values: 0 = Conservative, 1 = Liberal, and NA for both NA and Other.  
