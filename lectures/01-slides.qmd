...
See "Assessment" section of our Syllabus and the [Course Schedule](https://brinasab.github.io/css-website-summer/lectures/). It includes details n: 

-   **Assessment and Evaluation**

-   **Submission Policies** (including late or missed assignments)
...
* start early to work on the take-home assignments; (starting from the 2nd) they will be a bit challenging, especially if you have never programmed before
...
- Clarify expectations & be consistent 
...
- IS NOT allowed to brainstorm, write code for you, or replace course materials  

- IS allowed to debug and learn more (e.g., clarify class materials, ask for more explanations about a specific function, ask for examples, etc.). 

Read the [Academic Integrity & Use of AI Policies](https://brinasab.github.io/css-website/syllabus.html#academic-integrity-use-of-ai-policies)
...
If your group finishes early, please complete [this short survey](https://forms.gle/pKXDLNP8T92bYY7T6) if you haven’t already. It only takes a few minutes and helps us better understand your background and what you’re hoping to learn in this course.
:::
...
-   Log in into RStudio Workbench <https://macss-r.uchicago.edu/>
