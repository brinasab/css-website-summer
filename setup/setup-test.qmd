...
::: callout-note
Complete this tutorial to verify that your setup is working as expected. Do this **after** completing the [RStudio Workbench Setup](setup-workbench.qmd) otherwise it won't work! If you are unsure whether you have completed the required steps, return to the [software setup page](index.qmd) and follow the instructions.
:::
