...
**Due: Thursday, July 2nd (11:59 PM Chicago Time)**

In the first assignment you worked with your software setup, Git/GitHub via RStudio, and R Markdown. The goal of this second assignment is to practice transforming and exploring data with `dplyr` and `ggplot2`.
...
1. Go at [this link](https://classroom.github.com/a/eII6Nn23) to accept the invitation and create your private `hw02` repository on GitHub. Your repository will be named `hw02-<USERNAME>` and will be ready within a few seconds. If this does not work, see the note in red above.
...
2. When you're ready to submit:
   - Copy the URL of your GitHub repository. It will look something like: `https://github.com/css-summer26/hw02-yourusername`
