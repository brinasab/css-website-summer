...
1. Go at [this link](https://classroom.github.com/a/j2gOsj6i) to accept the invitation and create your private `hw01` repository on GitHub. Your repository will be named `hw01-<USERNAME>` and will be ready within a few seconds. If this does not work, see the note in red above.
...
2. When you're ready to submit:
   - Copy the URL of your GitHub repository. It will look something like: `https://github.com/css-summer26/hw01-yourusername`
